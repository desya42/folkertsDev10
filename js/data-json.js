...
xhr.onload = function () {                       // When readystate changes
  ...
  // BUILD UP STRING WITH NEW CONTENT (could a// NOTE: If you run this file locally
// You will not get a server status
// You can comment out lines 9 and 26 to make it work locally
...
// If you get it on a server, you may need to se the MIME type for JSON on the server (application/JSON).lso use DOM manipulation)
  var newContent = '';
  for (var i = 0; i < responseObject.events.length; i++) { // Loop through object
    newContent += '<div class="event">';
    newContent += '<img src="' + responseObject.events[i].map + '" ';
